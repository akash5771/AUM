...
// Helper to get NVIDIA API Key from .env.local
function getNvidiaApiKey() {
  // If it's already in process.env, use it
...
async function main() {
  ...
  if (!apiKey) {
    console.error('[Error] NVIDIA_API_KEY is not defined in process.env or .env.local');
    process.exit(1);
  }
